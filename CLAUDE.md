...
**goonj** — Cyrius port of a Rust project (14630 lines preserved at `rust-old/`).
...
goonj (गूँज — "echo, resonance") **owns acoustics for AGNOS**: sound
propagation, room simulation, ray/beam/image-source tracing, impulse-response
generation, diffraction, and resonance analysis. It builds on hisab for math
and serves dhvani, shruti, kiran/joshua, and aethersafha.
